...
const AddProduct = () => {
  const [product, setProduct] = useState({
    ...
    stockQuantity: "",
    releaseDate: "",
    productAvailable: true, // Default to true so it immediately shows up in the shop
  });
  ...
  const submitHandler = (event) => {
    ...
    axios
      ...
      .catch((error) => {
        toast.error(getApiErrorMessage(error, "Error adding product"));
        setLoading(false);
      });
  };
  ...
  return (
    <div className="container mt-5 pt-4">
      <form noValidate onSubmit={submitHandler} className="row g-4">
        ...
        {/* Product Available checkbox removed as per user request */}
